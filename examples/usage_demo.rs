use jwc::{JwcDeserializable, JwcSerializable, Node, Value, single_pass_parser};
use jwc_derive::{JwcDeserializable, JwcSerializable};
...
fn main() {
    ...
    if let Value::Object(ref mut members) = node_modified.value {
        ...
        entry.add_key_comment(" Number of retries");

        // Ensure trailing comma on previous element
