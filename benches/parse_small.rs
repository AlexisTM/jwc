//! Parse-only throughput on a small fixture (~350 bytes, mixed types).
//!
//! Run: `cargo bench --bench parse_small`
...
fn run(c: &mut Criterion) {
    let json = common::SMALL_JSON;
    let mut g = c.benchmark_group("parse_small");
