//! Parse-only throughput on a long-string fixture (~1.5 KB).
//!
//! Run: `cargo bench --bench parse_large`
...
fn run(c: &mut Criterion) {
    let json = common::build_large_json();
    let mut g = c.benchmark_group("parse_large");
